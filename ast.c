...
void process_node(ast_node node) {
	...
	if (token_table[i].token == NULL)
		...
		switch (node->node_type) {
			case IDENTIFIER:  /* get and store the actual id */
